const RestaurantIcon = ({ setSearchCategory }) => {

  return (
    <div onClick={() => setSearchCategory("restaurant")}>
      <svg xmlns="http://www.w3.org/2000/svg" width="72" height="63.7" viewBox="0 0 72 63.7">
        <g id="Restaurant_icon" data-name="Restaurant icon" transform="translate(-1358 -568.3)">
          ...
          <text id="restaurant" transform="translate(1358 628)" fontSize="16" fontFamily="SegoeUI, Segoe UI"><tspan x="0" y="0">restaurant</tspan></text>
        </g>
      </svg>
    </div>
  )
