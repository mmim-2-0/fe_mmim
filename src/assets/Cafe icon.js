...
const CafeIcon = ({ setSearchCategory, searchCategory }) => {
  ...
  return (
    <div onClick={(e) => handleClick(e)}>
      <svg xmlns="http://www.w3.org/2000/svg" width="60" height="50" viewBox="0 0 37 63" fill={iconColor}>
        <g id="Cafe_icon" data-name="Cafe icon" transform="translate(-1293 -569)">
          ...
          <text id="cafe" transform="translate(1308 628)" fontSize="14" fontFamily="SegoeUI, Segoe UI"><tspan x="-14" y="0">cafe</tspan></text>
        </g>
      </svg>
    </div>
  )
