...
const ParkIcon = ({ setSearchCategory, searchCategory }) => {
  ...
  return (
    <div onClick={(e) => handleClick(e)}>
      <svg xmlns="http://www.w3.org/2000/svg" width="60" height="50" viewBox="0 0 36 65" fill={iconColor}>
        <g id="Park_icon" data-name="Park icon" transform="translate(-1622 -567)">
          ...
          <text id="park" transform="translate(1622 628)" fontSize="14" fontFamily="SegoeUI, Segoe UI"><tspan x="0" y="0">park</tspan></text>
        </g>
      </svg>
    </div>
  )
