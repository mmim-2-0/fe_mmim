  ...
  return (
    <div className='Nav'>
      <div className='title-div'>
        <button className='nav-home-button' onClick={navigateHome}>
      ...
      <div className='login-container'>
        <a className='login-button' onClick={() => popupRef?.toggle()}>
          {!token ? "Login" : "Logout"}
        </a>

        <Popup
          trigger={<button className='login-popup-trigger'></button>}
          ref={popupRef}
          position='left'
        >
          {!token ? (
